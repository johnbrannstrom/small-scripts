...
if first:
    ...
    print('Place dnf client certificate here: /var/lib/dnf/client.crt')
    print('Place pip3 client cert here: /etc/pki/ca-trust/source/anchors/pip3.crt')
    print('Then run "update-ca-trust extract"')
